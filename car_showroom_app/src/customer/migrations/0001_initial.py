    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=14, validators=[django.core.validators.RegexValidator(regex='^\\+375 \\((17|29|33|44)\\) [0-9]{3}-[0-9]{2}-[0-9]{2}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('showroom', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='car_showroom.carshowroom')),
