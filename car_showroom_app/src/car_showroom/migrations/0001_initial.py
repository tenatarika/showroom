    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('сar_showroom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='showrooms', related_query_name='showroom', to='car_showroom.carshowroom')),
            ],
            options={
                'abstract': False,
            },
